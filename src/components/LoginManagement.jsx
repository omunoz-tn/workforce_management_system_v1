...
const MODULES = [
    ...
    { id: 'holidays', label: 'Holidays', category: 'Scheduling' },
    ...
    { id: 'settings-scheduling', label: 'Forecast Settings', category: 'Settings' },
    { id: 'org', label: 'Organization', category: 'Settings' },
    { id: 'login-mgmt', label: 'User (Users & Roles)', category: 'Settings' },
];
                        ...
                        {users.length > usersPerPage && (
                            <div className="pagination">
                                ...
                                <span className="pagination-info">
                                    Showing {Math.min(users.length, (currentPage - 1) * usersPerPage + 1)}-{Math.min(users.length, currentPage * usersPerPage)} of {users.length} users
                                </span>
                            </div>
                        )}
                    </div>
